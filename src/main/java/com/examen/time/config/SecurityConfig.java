        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(http -> {
                    http
                            ...
                            .requestMatchers(HttpMethod.GET, "/api/v1/time/**").hasAnyAuthority("READ")
                            .requestMatchers(HttpMethod.POST, "/api/v1/time/**").hasAnyAuthority("CREATE")
                            .requestMatchers(HttpMethod.PUT, "/api/v1/time/**").hasAnyAuthority("UPDATE")
                            .requestMatchers(HttpMethod.DELETE, "/api/v1/time/**").hasAnyAuthority("DELETE")
                            .anyRequest().denyAll();
                })
                .build();
    }
